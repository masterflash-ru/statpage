...
insert into statpage (name,sysname,url,locale,tpl,page_type,lastmod,content,title,keywords,description)
select s.name,s.sysname,s.url,
t.locale,t.tpl,t.page_type,t.lastmod,t.content,t.title,t.keywords,t.description
